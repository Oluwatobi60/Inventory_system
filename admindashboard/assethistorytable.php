...
try {
    ...
    $count_sql3 = "SELECT COUNT(*) as total FROM asset_replacement_log $where3";
                        ...
                        <tbody>
                            <?php $i3 = 1; foreach ($replaced_assets as $row): ?>
                                <tr>
                                    ...
                                    <td><?php echo htmlspecialchars($row['department']); ?></td>
                                    <td><?php echo htmlspecialchars($row['floor']); ?></td>
                                    <td><?php echo htmlspecialchars($row['replaced_at']); ?></td>
                                    <td><?php echo htmlspecialchars($row['replaced_quantity']); ?></td>
                                   <!--  <td>
                                        <a href="viewhistory.php?id=<?php //echo $row['id']; ?>" class="btn btn-primary btn-sm">
                                            <i class="fas fa-eye"></i> View
                                        </a>
...
<?php
    ...
    echo '<div class="alert alert-danger">An error occurred while fetching the data. Please try again later.<br>' . htmlspecialchars($e->getMessage()) . '</div>';
}
?>