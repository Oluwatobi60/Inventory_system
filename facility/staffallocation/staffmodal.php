                                ...
                                <div class="asset-entry mb-4">
                                    <div class="row"><!--first row-->
                                     ...
                                     <div class="row mt-3">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="floor-select" class="col-form-label">Floor:</label> <!-- Label for assigned employee -->
                                                <select id="floor-select" class="form-control" name="floor"> <!-- Dropdown for assigned employee -->
                                                    <option selected disabled>Select Floor</option>                                
                                                <?php                                     
                                                    $sql = "SELECT floor FROM department_table ORDER BY department";
                                                    $stmt = $conn->prepare($sql);
                                                    $stmt->execute();
                                                    while($row = $stmt->fetch()){
