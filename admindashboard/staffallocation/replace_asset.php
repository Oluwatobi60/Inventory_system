...
try {
    // Mark the asset as replaced in repair_asset and set replaced field to 1
    $sql = "UPDATE repair_asset SET status = NULL, replaced_date = NOW(), replaced = 1 WHERE asset_id = :asset_id AND status = 'Withdrawn'";
